    ...
    <div className="container mx-auto px-4 py-12 flex flex-col min-h-screen">
      <div className="mb-12 text-center max-w-3xl mx-auto">
        ...
        <div className="relative max-w-xl mx-auto">
          ...
          <input type="text" placeholder="Search articles..." className="w-full bg-gray-900 border border-gray-700 rounded-full pl-12 pr-6 py-3 focus:outline-none focus:border-blue-500 text-white shadow-lg" />
        </div>
      </div>

      <div className="flex gap-4 overflow-x-auto pb-4 mb-8 justify-center">
        <button className="px-5 py-2 bg-blue-600 text-white rounded-full text-sm font-medium whitespace-nowrap">All Posts</button>
        <button className="px-5 py-2 bg-gray-900 text-gray-400 hover:text-white rounded-full text-sm font-medium transition-colors whitespace-nowrap border border-gray-800">Industry News</button>
        <button className="px-5 py-2 bg-gray-900 text-gray-400 hover:text-white rounded-full text-sm font-medium transition-colors whitespace-nowrap border border-gray-800">Firm Updates</button>
        <button className="px-5 py-2 bg-gray-900 text-gray-400 hover:text-white rounded-full text-sm font-medium transition-colors whitespace-nowrap border border-gray-800">Trading Guides</button>
      </div>
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
        {[
          { title: 'FTMO Updates MetaTrader 5 Conditions for Crypto Traders', category: 'Firm Updates', date: 'Oct 20, 2026' },
          { title: '5 Psychological Traps to Avoid During Your Evaluation', category: 'Trading Guides', date: 'Oct 15, 2026' },
          { title: 'Comparing the Best Instant Funding Prop Firms', category: 'Industry News', date: 'Oct 12, 2026' },
          { title: 'How to Master the 30% Consistency Rule', category: 'Trading Guides', date: 'Oct 08, 2026' },
          { title: 'Apex Trader Funding Announces New Rithmic Integration', category: 'Firm Updates', date: 'Oct 05, 2026' },
          { title: 'US Regulatory Changes: How They Impact Retail Traders', category: 'Industry News', date: 'Sep 28, 2026' },
        ].map((post, i) => (
          <div key={i} className="bg-gray-900 border border-gray-800 rounded-xl overflow-hidden flex flex-col group hover:border-gray-700 transition-colors">
            <div className="h-48 bg-gray-800 relative">
               <div className="absolute inset-0 flex items-center justify-center text-gray-600 text-xs">Image</div>
            </div>
            <div className="p-6 flex flex-col flex-1">
              ...
              <Link href="#" className="text-blue-500 hover:text-blue-400 font-medium flex items-center gap-1 text-sm mt-auto">
